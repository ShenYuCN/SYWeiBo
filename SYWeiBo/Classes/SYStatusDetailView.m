...
@implementation SYStatusDetailView

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"statusDetail";
    SYStatusDetailView *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[SYStatusDetailView alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
